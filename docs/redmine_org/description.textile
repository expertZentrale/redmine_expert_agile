...
* *Colours* — cards coloured by tracker, priority, status, project, assignee or spent time, from a fixed palette of 18 shades picked as swatches rather than by name. Deliberately by what an issue is, never one issue at a time.
