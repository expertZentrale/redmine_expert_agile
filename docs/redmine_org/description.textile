...
* *Colours* — cards coloured by tracker, priority, status, project, assignee, spent time, or per issue, from a fixed palette of 18 shades picked as swatches rather than by name.
